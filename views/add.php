...
<body>
	<div class="container">
		<a class="btn btn-primary mt-5" href="./contact.php" role="button">Liste des contacts</a>
		<br/><br/>

		<div class="modal-dialog" role="log">
			<div class="modal-content rounded-5 shadow">
				<div class="modal-body p-5 pt-0 mt-5">
					<form class="" action="../controllers/add.php" method="post"> 
						...
						<div class="form-floating mb-3">
							<input type="email" class="form-control rounded-4" name="email" id="floatingPassword"
								placeholder="exemple@email.fr" required="required">
							<label for="floatingPassword">Email</label>
						</div>
						<div class="col text-center">
							<button class="w-50 mb-2 mt-5 btn rounded-4 btn-primary col text-center" type="submit">Ajouter</button>
						</div>
					</form>
				</div>
			</div>
